...
def function4():
    ...
    return np.hstack((my_array[:,[1, 0]],my_array[:,[2, 3]]))  #wrtie your code here
    """
    Expected Output:
          array([[1, 0, 2],
                [4, 3, 5],
...
def function14():
    ...
    ans = arr.split(arr,4) #write your code here 
...
def function15():
    ...
    ans = arr[:3, 1:2] = np.sort(arr[:3, 1:2],axis=0) #write your code here 
...
def function18():
    ...
    x = len(set(students)&set(piaic)) # Write you code Here
    return x
